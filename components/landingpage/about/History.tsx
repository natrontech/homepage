    ...
    return (
        ...
        >
            ...
            >
                ...
                <br /><br />
                <strong>Open source</strong> is very close to Natron&apos;s heart, so it is also central to give something back to the community in the form of contributions or donations. Furthermore it will be the goal to start own open-source projects.
            </p>
        </div>
    )
}