        ...
        <div className="h-128 sm:hover:scale-105 active:hover:scale-105 transition-all duration-150 ease-in-out">
          <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} className="h-128">
            <ExportedImage
              ...
              layout="fill"
            />
            <div className="absolute inset-0 bg-gradient-to-r from-primary mix-blend-normal"></div>
            <div
            ...
            <div className="absolute bottom-5 left-5 translate-z-4 text-white">
              <p className="text-sm font-GilroyLight">&quot;{nickname}&quot;</p>
              <h1 className="text-3xl font-GilroyBold">{name}</h1>
              <p className="text-sm font-GilroyLight mb-5">{position}</p>
              <span onClick={sendMail} className="inline">
