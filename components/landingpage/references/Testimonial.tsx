...
export default function Testimonial({ logoimage, personimage, name, position }: { logoimage: string, personimage: string, name: string, position: string }) {
    return (
        <section className="py-12 overflow-hidden md:py-20 lg:py-24 border-8 border-primary">
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="relative">
                    <div
                        className="h-10 w-32 relative m-auto"
                    >
                        <ExportedImage
                        ...
                        <footer className="mt-8">
                            <div className="md:flex md:items-center md:justify-center">
                                <div className="md:flex-shrink-0">
                                    <div
                                        className="h-14 w-14 relative m-auto "
                                    >
                                        <ExportedImage
                                ...
                                <div className="mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center">
                                    ...
                                    <div className="text-base font-medium text-gray-200">{position}</div>
                                </div>
                            </div>
                        </footer>
                    </blockquote>
