...
export default function Technologies() {
  ...
  const providers = [
    ...
    },
    {
      ...
      services: ["Accounting", "Invoicing", "Payment", "CRM"],
      country: "Switzerland",
    },
    {
      name: "Cloudflare",
      link: "https://www.cloudflare.com/",
      services: ["DNS", "ACME DNS Challenge"],
      country: "USA",
    },
    {
      name: "Hostpoint",
    ...
    },
    {
      ...
      services: ["Design", "Prototyping", "Wireframing", "UI/UX"],
      country: "USA",
    },
    {
      name: "Slack",
  ...
  return (
    <div id="technologies" className="py-20">
        ...
        >
          {technologies.map((item: any, index: number) => {
            return (
              ...
              >
                <div className="group relative col-span-1 py-10 border-primary border-8 flex justify-center cursor-pointer transition-all duration-200 ease-in-out">
                  <div className="h-20 w-52 relative m-auto">
                    <ExportedImage
                  ...
                  <div className="font-GilroyBold text-3xl w-full sm:w-2/3 sm:opacity-0 group-hover:w-full group-hover:opacity-100 absolute bottom-0 left-0 bg-primary sm:pt-2 pt-1 -mb-2 sm:mb-0 px-4 group-hover:translate-y-0 transition-all duration-200 ease-in-out">
                    {item.name}
                  </div>
                </div>
              </a>
      ...
      <h2 className="sm:text-xl text-xl m-auto font-GilroyBold text-center mb-20">
        ...and many more...
      </h2>
      <h1 className="sm:text-6xl text-5xl font-GilroyBold text-center mb-2">
        We are <span className="text-primary">built</span> on
      </h1>
      <p className="text-lg mb-20 text-center text-gray-300">#transparency</p>
      <div className="grid lg:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-4 sm:gap-10">
        {providers.map((item: any, index: number) => {
          return (
            ...
            >
              <div className="absolute bottom-2 right-2 font-GilroyLight text-sm">
                &#40;{item.country}&#41;
              </div>
              <div className="absolute top-5 right-5">
                <LinkIcon width={25} height={25} color="white" />
              </div>
              <h1 className="text-center text-2xl font-GilroyBold mb-5">
                {item.name}
              </h1>
              <div className=" text-left text-lg font-GilroyRegular">
