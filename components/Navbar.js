...
import { ChipIcon, MenuIcon, TicketIcon, XIcon } from '@heroicons/react/outline'
import { ChevronDownIcon } from '@heroicons/react/solid'
import logo_font from '../public/images/logo/natron_logo_font.svg'
import Link from 'next/link'

const solutions = [
  {
    name: 'PaaS',
    description: 'Erhalten Sie einen Überblick von der Container Plattform',
    href: '#',
    icon: ChipIcon,
  },
  {
    name: 'Support',
    description: 'Erfassen Sie ein Ticket mit Ihrer Anfrage',
    href: 'mailto:support@bluestone.ch',
    icon: TicketIcon,
  },
  // { 
  //   name: 'Live Chat', 
        ...
        <Popover className="relative bg-white">
          <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
            ...
            <Popover.Group as="nav" className="hidden md:flex space-x-10">
              ...
              <Link href="/" className="text-base font-medium text-gray-500 hover:text-gray-900" to='/pricing'>
                Pricing
              </Link>     
