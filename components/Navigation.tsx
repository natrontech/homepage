...
export default function Navigation(props: any) {
  ...
  return (
    <div className="relative h-screen">
      <div className="text-center space-y-10 lg:text-left absolute top-1/2 left-1/2 lg:left-20 lg:-translate-x-0 w-full -translate-x-1/2 -translate-y-1/2">
      ...
      <div className="absolute grid w-full lg:w-auto grid-cols-2 lg:grid-cols-1 lg:bottom-20 lg:right-20 bottom-5">
        <div className="lg:mb-10 mx-5 lg:mx-0">
