...
export default function Footer(props: any) {
    return (
        ...
        >
            ...
            <div
                className="absolute left-1/2 -translate-x-1/2 mt-5 inline"
            >
                <a
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-github inline" viewBox="0 0 16 16">
                ...
                <a
                    ...
                    className="cursor-pointer"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-linkedin inline" viewBox="0 0 16 16">
